...
//change this depending on the used model query 
// for example, Face-Landmarks model uses "photo" for query
//              PoseNet model uses "image" for query
String QueryKey="photo"; 
